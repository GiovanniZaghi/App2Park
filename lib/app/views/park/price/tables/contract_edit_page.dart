...
class ContractEdit extends StatefulWidget {
  @override
  _ContractEditState createState() => _ContractEditState();
}

class _ContractEditState extends State<ContractEdit> {
  ...
  loadSharedPrefs() async {
    try {
      ...
      AgreementsOff a =
      AgreementsOff.fromJson(await sharedPref.read("permanencia"));
      ...
      setState(() {
        ...
        boleto = a.bank_slip_send == 1 ? true : false;
        ...
        pago = a.status_payment == 1 ? true : false;
      ...
      LogOff logOff = LogOff('0', null, null, e.toString(), 'IN PROD VERSION', now.toString(), 'ERRO CONTRACT EDIT PAGE', 'APP');
  ...
  Widget build(BuildContext context) {
    return Scaffold(
      appBar: AppBar(
        ...
        title: Text('Contrato de Permanencia'),
      ),
      body: _body(context),
    );
  }
                    ...
                    RaisedButton(
                      ...
                      onPressed: () {
                        DatePicker.showDatePicker(context,
                            ...
                            }, currentTime: DateTime.parse(_date), locale: LocaleType.pt);
                      },
                      child: Container(
                    ...
                    RaisedButton(
                      ...
                      onPressed: () {
                        DatePicker.showDatePicker(context,
                            ...
                            }, currentTime: DateTime.parse(_enc), locale: LocaleType.pt);
                      },
                      child: Container(
                        alignment: Alignment.center,
                        height: 50.0,
                              ...
                              if (connectivityResult ==
                                ...
                                if (id_agreement != 0) {
                                  ...
                                  agreement.company_email =
                                      _emailJuridico.text.toLowerCase();
                                  agreement.bank_slip_send = boleto ? '1' : '0';
  ...
  Widget okButton = FlatButton(
    ...
    onPressed: () {
      Navigator.of(context).pushNamedAndRemoveUntil(
          PermanenceListViewRoute, (Route<dynamic> route) => false);
    },
  );
