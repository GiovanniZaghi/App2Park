...
class EntryOptionsService extends StatefulWidget {
  @override
  _EntryOptionsServiceState createState() => _EntryOptionsServiceState();
}

class _EntryOptionsServiceState extends State<EntryOptionsService> {
  int id = 0;
  int id_vehicle = 0;
  Park park = Park();
  User user = User();
