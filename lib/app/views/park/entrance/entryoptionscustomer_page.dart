...
class EntryOptionsCustomer extends StatefulWidget {
  @override
  _EntryOptionsCustomerState createState() => _EntryOptionsCustomerState();
}
class _EntryOptionsCustomerState extends State<EntryOptionsCustomer> {
