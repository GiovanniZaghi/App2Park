...
class CheckDataSimpleOffPage extends StatefulWidget {
  @override
  _CheckDataSimpleOffPage createState() => _CheckDataSimpleOffPage();
}

class _CheckDataSimpleOffPage extends State<CheckDataSimpleOffPage> {
  Timer _timer;
              ...
              children: <Widget>[
                ...
                avulso
                  ...
                  onPressed: () async {
                    ...
                    sharedPref.save("entrada", cupom_checkin_datetime);
                    sharedPref.remove('model');
                    sharedPref.save('model', modelo);
                ...
                ButtonApp2Park(
                  ...
                  onPressed: () {
                    //Navigator.of(context).pushNamed(EntryCarSimpleViewRoute);
