...
class Permanence extends StatefulWidget {
  @override
  _PermanenceState createState() => _PermanenceState();
}

class _PermanenceState extends State<Permanence> {
  ...
  loadSharedPrefs() async {
    try {
      ...
      LogOff logOff = LogOff('0', null, null, e.toString(), 'IN PROD VERSION', now.toString(), 'ERRO PERMANENCE PAGE', 'APP');
