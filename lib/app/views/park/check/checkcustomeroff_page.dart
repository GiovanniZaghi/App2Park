...
class CheckCustomerOffPage extends StatefulWidget {
  @override
  _CheckCustomerOffPageState createState() => _CheckCustomerOffPageState();
}
class _CheckCustomerOffPageState extends State<CheckCustomerOffPage> {
  ...
  loadSharedPrefs() async {
    try {
      ...
      LogOff logOff = LogOff('0', null, null, e.toString(), 'IN PROD VERSION', now.toString(), 'ERRO CUSTOMER OFF PAGE', 'APP');
                      ...
                      child: Column(
                        children: <Widget>[
                                  ...
                                  return Padding(
                                    ...
                                    child: InkWell(
                                      ...
                                      onTap: ()async {
                                        ...
                                        Navigator.of(context).pushNamed(CheckObjectViewRoute);
                                      },
                                    ),
                                  );
                                }
                          ...
                          ButtonApp2Park(
                            text: 'Criar um novo',
                            onPressed: (){
                              Navigator.of(context).pushNamed(CreateCustomerOffPageViewRoute);
                            },
                          ),
                        ],
                      ),
