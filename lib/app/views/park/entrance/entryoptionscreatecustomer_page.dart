...
class EntryOptionsCreateCustomer extends StatefulWidget {
  @override
  _EntryOptionsCreateCustomerState createState() => _EntryOptionsCreateCustomerState();
}

class _EntryOptionsCreateCustomerState extends State<EntryOptionsCreateCustomer> {
          ...
          children: <Widget>[
            ...
            isLoading ? Row(
              ...
              onPressed: () async {
                ...
                print("id_vehicle_customer $id_vehicle_customer");
                ...
                Navigator.of(context).pushNamedAndRemoveUntil(EntryOptionsViewRoute, (route) => false);
              },
