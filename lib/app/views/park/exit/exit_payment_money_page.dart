...
class ExitPaymentMoney extends StatefulWidget {
  @override
  _ExitPaymentMoneyState createState() => _ExitPaymentMoneyState();
}

class _ExitPaymentMoneyState extends State<ExitPaymentMoney> {
