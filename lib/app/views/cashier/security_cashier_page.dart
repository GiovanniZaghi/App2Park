...
class SecurityCashierPage extends StatefulWidget {
  @override
  _SecurityCashierPageState createState() => _SecurityCashierPageState();
}

class _SecurityCashierPageState extends State<SecurityCashierPage> {
    ...
    return isLoading ? isLoadingPage() : Container(
      child: ListView(
        children: <Widget>[
          ...
          Text(
            'Nome do Responsável que retirou o Dinheiro',
            style: TextStyle(fontSize: 18, fontWeight: FontWeight.bold),
          ),
          Padding(
            ...
            child: TextField(
              ...
              decoration: InputDecoration(
                hintText:
                    'Digite o Nome do Responsável que retirou o Dinheiro ',
                errorText: _validate
                    ? 'Nome do Responsável minimo de 10 digitos'
                    : null,
            ...
            child: ButtonApp2Park(
              ...
              onPressed: () async {
                ...
                if (_value.text.length < 10) {
                  ...
                  double price = _cash.numberValue;
                  double dinheiroF = _cash.numberValue * -1;
                  if (_cash.numberValue > 0.00) {
                    setState(() {
                      _cashValidate = false;
                    });
                    ...
                    if (connectivityResult == ConnectivityResult.mobile ||
                      ...
                      cashMovement.id_cash_type_movement =  '5';
