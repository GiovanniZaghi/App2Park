...
part of 'price_detached_off_inner_model.dart';

// **************************************************************************
// JsonSerializableGenerator
// **************************************************************************

PriceDetachedInnerJoinOff _$PriceDetachedInnerJoinOffFromJson(
    Map<String, dynamic> json) {
  return PriceDetachedInnerJoinOff(
    json['id'] as int,
    json['id_park'] as int,
    json['name'] as String,
...
Map<String, dynamic> _$PriceDetachedInnerJoinOffToJson(
        PriceDetachedInnerJoinOff instance) =>
    <String, dynamic>{
      'id': instance.id,
