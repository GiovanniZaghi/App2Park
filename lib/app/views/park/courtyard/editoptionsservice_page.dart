...
class EditOptionsService extends StatefulWidget {
  @override
  _EditOptionsServiceState createState() => _EditOptionsServiceState();
}

class _EditOptionsServiceState extends State<EditOptionsService> {
  int id = 0;
  int id_vehicle = 0;
  Park park = Park();
  User user = User();
  ...
  loadSharedPrefs() async {
    try {
      ...
      print(parkServiceInnerJoinServiceAdditionalList);
                                ...
                                i++) {
                                  ...
                                  if (parkService.tickado == 1) {
                                    ...
                                    if (connectivityResult ==
                                      ...
                                      print(ticketServiceAdditionalModelR);
