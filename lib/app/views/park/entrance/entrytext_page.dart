...
class EntryTextPage extends StatefulWidget {
  @override
  _EntryTextPageState createState() => _EntryTextPageState();
}

class _EntryTextPageState extends State<EntryTextPage> {
  bool placaValida;
  ...
  loadSharedPrefs() async {
    try {
      ...
      LogOff logOff = LogOff('0', null, null, e.toString(), 'IN PROD VERSION', now.toString(), 'ERRO ENTRTEXT PAGE', 'APP');
          ...
          ButtonApp2Park(
            ...
            onPressed: () async {
              if(_placa.text.isEmpty){
                ...
                Navigator.of(context).pushNamed(CheckDataOffViewRoute);
              }
