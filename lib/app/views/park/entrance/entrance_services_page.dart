...
class EntranceService extends StatefulWidget {
  @override
  _EntranceServiceState createState() => _EntranceServiceState();
}

class _EntranceServiceState extends State<EntranceService> {
  ...
  String modelo = '';
  String type = '';
  String entrada = DateFormat("yyyy-MM-dd HH:mm:ss").format(DateTime.now()).toString();
  ...
  DateTime tolerancia = DateTime.parse('2020-09-28 00:00:00');
  DateTime saidaEsta;
  ...
  loadSharedPrefs() async {
    try {
      ...
      String pla = await sharedPref.read("placa");
      ...
      int id_price_detached_app = await sharedPref.read("id_price_detached_app");
      ...
      setState(() {
        ...
        String esta = DateFormat('yyyy-MM-dd HH:mm:ss').format(todayDate.add(Duration(days: tolerancia.day,hours: tolerancia.hour, minutes: tolerancia.minute, seconds: tolerancia.second))).toString();
            ...
            children: <Widget>[
              ...
              Row(
                children: <Widget>[
                  ...
                  Text(
                    loadDate(DateTime.parse(entrada)),
                    style: TextStyle(fontSize: 18),
                  ),
                ],
              ),
                    ...
                    child: Row(
                      ...
                      children: <Widget>[
                        ...
                        tolerancia.toString() == '00:00:00' ? Text(
                          ...
                          loadDate(tolerancia) != null ? loadDate(tolerancia) : '',
                          style: TextStyle(fontSize: 18),
                        ),
                      ],
                    ),
