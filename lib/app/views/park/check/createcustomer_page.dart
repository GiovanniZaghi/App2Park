...
class CreateCustomerOffPage extends StatefulWidget {
  @override
  _CreateCustomerOffPageState createState() => _CreateCustomerOffPageState();
}

class _CreateCustomerOffPageState extends State<CreateCustomerOffPage> {
  ...
  loadSharedPrefs() async {
    try {
      ...
      LogOff logOff = LogOff('0', null, null, e.toString(), 'IN PROD VERSION', now.toString(), 'ERRO CREATE CUSTOMER PAGE', 'APP');
