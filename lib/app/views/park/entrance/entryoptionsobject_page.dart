...
class EntryOptionsObject extends StatefulWidget {
  @override
  _EntryOptionsObjectState createState() => _EntryOptionsObjectState();
}

class _EntryOptionsObjectState extends State<EntryOptionsObject> {
