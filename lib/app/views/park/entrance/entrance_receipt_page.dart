...
class EntranceReceiptPage extends StatefulWidget {
  @override
  _EntranceReceiptPageState createState() => _EntranceReceiptPageState();
}


class _EntranceReceiptPageState extends State<EntranceReceiptPage> {
  Park park = Park();
  ...
  String link = "www.app2park.com.br";
  String ticket = "";
      ...
      setState(() {
        ...
        eList.forEach((element) {
          ...
          if(element.nome == 'Total'){
            ...
            extratoList.add('${element.nome}  ${DateFormat("dd/MM/yyyy HH:mm:ss").format(element.tempo).toString()}');
          }else{
                ...
                Padding(
                  ...
                  child: Row(
                    ...
                    children: <Widget>[
                      ...
                      Text(saida,style: TextStyle(fontSize: 18),),
                    ],
                  ),
                ),
                SizedBox(height: 35,),
            ...
            ButtonApp2Park(
              ...
              onPressed: (){
                Navigator.of(context).pushNamedAndRemoveUntil(
                    CheckTicketOffViewRoute, (Route<dynamic> route) => false);
              },
            ),
